function Main_Frame(parent_div, connector) {
  ...
  this.home_tab = new Home_Tab(this.nav_bar, this.tab_content,
    this.connector);
  this.account_tab = new Account_Tab(this.nav_bar, this.tab_content,
    this.connector);
  this.category_tab = new Category_Tab(this.nav_bar, this.tab_content,
    this.connector);
  this.transaction_tab = new Transaction_Tab(this.nav_bar, this.tab_content,
    this.connector);
